  ...
  stages {
    ...
    stage('apply') {
      steps {
        ...
        sh "terraform output home-ui | tr -d \'\"\' & echo -n 'ansible_ssh_private_key_file=/var/lib/jenkins/.ssh/home.pem' >> ./ansible/hosts"
//         sh "echo -n 'ansible_ssh_private_key_file=/var/lib/jenkins/.ssh/home.pem' >> ./ansible/hosts"
